  ...
  useGSAP(() => {
    ...
    boxes.forEach((box) => {
      gsap.to(box, {
        ...
        scale: 1.5,
        scrollTrigger: {
          trigger: box, // The element to trigger the animation
          start: "bottom bottom", // The start position of the trigger
          end: "top 10%", // The end position of the trigger
          scrub: true, // Scrub the animation on scroll
        },
      });
  });
}, {scope: scrollRef});
